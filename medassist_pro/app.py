...
from medassist_pro.helper import download_hugging_face_embeddings, hybrid_search, load_documents, chunk_by_headings, use_faiss_vectorstore
...
from medassist_pro.prompt import *
import os
...
if use_faiss:
    ...
    from medassist_pro.helper import dicts_to_documents
...
def chat():
    ...
    response = rag_chain.invoke({"input": msg, "chat_history": memory.load_memory_variables({})["chat_history"]})
